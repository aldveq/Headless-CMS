 ...
 */
function taskbook_limit_rest_view_to_logged_is_users($is_allowed, $cmb_controller) {
 ...
 * 
 * @param array $fields_args Array of field arguments
 * @param CMB2_Field $field The field object
 */
function taskbook_status_cb($fields_args, $field) {
...
function taskbook_register_rest_api_box() {
    $cmb_rest = new_cmb2_box(array(
        ...
        'get_box_permissions_check_cb' => 'taskbook_limit_rest_view_to_logged_is_users',
    ));
    ...
    $cmb_rest->add_field(array(
        ...
        'before' => '<p>' . esc_html__( 'What is your stress level thinking about the upcoming task?', 'taskbook' ),
    ));
    ...
    $cmb_rest->add_field(array(
        ...
        'before' => '<p>' . esc_html__( 'What was the actual experience of working with the task like?', 'taskbook' ),
    ));
